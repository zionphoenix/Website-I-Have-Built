...
--
-- Host: localhost
-- Generation Time: Dec 20, 2016 at 05:41 AM
...
(1, 'How To Make Money Playing Games', 0.99, 10000);
...
--
ALTER TABLE `reviews`
  MODIFY `review_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
