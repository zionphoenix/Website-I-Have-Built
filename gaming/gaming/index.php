...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <span class="w3-xlarge w3-display-bottommiddle w3-black w3-round w3-padding-16
...
<div class="bgimg-2 w3-display-container w3-grayscale-min" id="home">
  ...
  w3-padding-left w3-padding-right w3-center" style="opacity:0.9;">
    How Much Players Are Making Using Our Method
...
<!-- Purchase Reason Three -->
<div class="bgimg-4 w3-display-container w3-grayscale-min" id="home">
  <span class="w3-xlarge w3-display-middle w3-black w3-round w3-padding-16
  w3-padding-left w3-padding-right w3-center" style="opacity:0.9;">
    Live Lavish
  </span>
...
<div class="w3-container w3-padding-32 w3-center" id="purchase">
  <div class="w3-container">
    ...
    <p class="w3-xlarge">Learn How For Just $0.99<a style="font-size:2px;">/day</a></p>
