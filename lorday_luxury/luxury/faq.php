  ...
  <div>
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        ...
        <p class="w3-medium w3-padding-left w3-padding-right">
          We process your transaction & deliver the documents regarding how to
          initiate a highly lucrative business to your email within three to
          five business days.
        </p>
      </div>
    </div>
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        ...
        <p class="w3-medium w3-padding-left w3-padding-right">
          All the information you will require will be within what wil be emailed
          to you, within three to five business days, after you have decided to
          purchase.
        </p>
      </div>
    </div>
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        ...
        <p class="w3-medium w3-padding-left w3-padding-right">
          At admin@lorday.com, or through the Help/Contact page, found at the
          bottom of all our website pages.
        </p>
      </div>
    </div>
