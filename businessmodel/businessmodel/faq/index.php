...
<div class="w3-row-padding w3-center" style="margin-top:85px;">
  <h3 class="w3-center">
    <i class="fa fa-question-circle" style="font-size:25px; color:#770000;"></i>
...
<div class="w3-row-padding w3-center w3-padding-left w3-padding-right" style="margin-bottom:15px;">
  <div>
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        <p class="w3-large w3-padding-left w3-padding-right">
          Why is the startup cost so low?
        </p>
        <p class="w3-medium w3-padding-left w3-padding-right">
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        ...
        <p class="w3-medium w3-padding-left w3-padding-right">
          After your payment has been processed & recieved by Lorday Enterprise,
          of which Lorday Business Model is a subsidiary, documents regarding this
          business model will then be emailed to you within 7-10 business days.
        </p>
      </div>
    </div>
    ...
    <div class="w3-card-2 w3-padding-top w3-padding-bottom w3-round w3-light-grey" style="margin-top:15px;">
      <div class="w3-center w3-margin-bottom">
        ...
        <p class="w3-medium w3-padding-left w3-padding-right">
          ...
          packages remaining stagnant, Lorday Business Model, & its creators, felt an
